...
declare type PropertyKeys = string | number | symbol;
...
interface Object {
    /**
      ...
      */
    hasOwnProperty(v: PropertyKeys): boolean;

    /**
      * Determines whether a specified property is enumerable.
      * @param v A property name.
      */
    propertyIsEnumerable(v: PropertyKeys): boolean;
}
...
interface ObjectConstructor {
    ...
    */
    getOwnPropertyDescriptor(o: any, PropertyKeys: PropertyKeys): PropertyDescriptor;
    ...
    /**
      ...
      *  property.
      */
    defineProperty(o: any, PropertyKeys: PropertyKeys, attributes: PropertyDescriptor): any;
}
...
declare namespace Reflect {
    ...
    function defineProperty(target: any, PropertyKeys: PropertyKeys, attributes: PropertyDescriptor): boolean;
    function deleteProperty(target: any, PropertyKeys: PropertyKeys): boolean;
    function enumerate(target: any): IterableIterator<any>;
    function get(target: any, PropertyKeys: PropertyKeys, receiver?: any): any;
    function getOwnPropertyDescriptor(target: any, PropertyKeys: PropertyKeys): PropertyDescriptor;
    function getPrototypeOf(target: any): any;
    function has(target: any, PropertyKeys: PropertyKeys): boolean;
    function isExtensible(target: any): boolean;
    function ownKeys(target: any): Array<PropertyKeys>;
    function preventExtensions(target: any): boolean;
    function set(target: any, PropertyKeys: PropertyKeys, value: any, receiver?: any): boolean;
...
interface DictConstructor {
    ...
    keys<T>(object: Dict<T>): IterableIterator<PropertyKeys>;
    entries<T>(object: Dict<T>): IterableIterator<[PropertyKeys, T]>;
    has<T>(object: Dict<T>, key: PropertyKeys): boolean;
    get<T>(object: Dict<T>, key: PropertyKeys): T;
    set<T>(object: Dict<T>, key: PropertyKeys, value: T): Dict<T>;
    forEach<T>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => void, thisArg?: any): void;
    map<T, U>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => U, thisArg?: any): Dict<U>;
    mapPairs<T, U>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => [PropertyKeys, U], thisArg?: any): Dict<U>;
    filter<T>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => boolean, thisArg?: any): Dict<T>;
    some<T>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => boolean, thisArg?: any): boolean;
    every<T>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => boolean, thisArg?: any): boolean;
    find<T>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => boolean, thisArg?: any): T;
    findKey<T>(object: Dict<T>, callbackfn: (value: T, key: PropertyKeys, dict: Dict<T>) => boolean, thisArg?: any): PropertyKeys;
    keyOf<T>(object: Dict<T>, value: T): PropertyKeys;
    includes<T>(object: Dict<T>, value: T): boolean;
    reduce<T, U>(object: Dict<T>, callbackfn: (previousValue: U, value: T, key: PropertyKeys, dict: Dict<T>) => U, initialValue: U): U;
    reduce<T>(object: Dict<T>, callbackfn: (previousValue: T, value: T, key: PropertyKeys, dict: Dict<T>) => T, initialValue?: T): T;
    turn<T, U>(object: Dict<T>, callbackfn: (memo: Dict<U>, value: T, key: PropertyKeys, dict: Dict<T>) => void, memo: Dict<U>): Dict<U>;
    turn<T>(object: Dict<T>, callbackfn: (memo: Dict<T>, value: T, key: PropertyKeys, dict: Dict<T>) => void, memo?: Dict<T>): Dict<T>;
}
...
declare namespace core {
    ...
    namespace Reflect {
        ...
        function getOwnPropertyDescriptor(target: any, PropertyKeys: PropertyKeys): PropertyDescriptor;
        function getPrototypeOf(target: any): any;
        function has(target: any, PropertyKeys: string): boolean;
        function has(target: any, PropertyKeys: symbol): boolean;
        function isExtensible(target: any): boolean;
        function ownKeys(target: any): Array<PropertyKeys>;
        function preventExtensions(target: any): boolean;
        function set(target: any, PropertyKeys: PropertyKeys, value: any, receiver?: any): boolean;
